...
<body>
  ...
  <div class=" py-2 container">
    <div class="my-3">
      <input onfocus="listar()" id="filtro-nome" type="text" value="" title="Procurar apenas por nome!"
        placeholder="Procurar..."> <br>
    </div>
    ...
    <a class="mx-3" href="perfilUsuario.php"> <button type="button" class="btn btn-outline-primary"> Voltar</button>
    </a>
  </div>
