...
<body>
  ...
  <div class="container ">
    <div class="container">
      <h1 class="m-3 txAzul d-flex justify-content-center fontWeight" style="white-space: nowrap; ">Seja
        bem-vindo(a), <?php echo $usuario->nome  ?></h1>
    </div>
  </div>
    ...
    <div>
      <div class="row m-2 fontSize">
        <div class="col-lg-4 order-2 order-lg-1">
          <img class="d-block rounded-circle mt-2 mb-0 mx-auto imagemcertinha"
            src="imagens/<?php echo $usuario->imagem ?>" width="200" height="200">
        </div>
        <div class="col-lg-4 d-flex flex-column justify-content-center order-1 order-lg-2">
          <h3 class="fontWeight txAzul">Informações</h3>
          <p class="mb-3 ">
            <?php echo $usuario-> nome." ".$usuario->sobrenome  ?><br><?php echo $usuario->telefone  ?><br><?php echo $usuario->email  ?>
          </p>
    ...
    <div class=" container px-4 py-5">
      <div class="row">
        <?php 
          ...
          ?>
        <div class="col-md"><a class="btn text-white btn-lg btn-block bgAzul butHover" href="feedAnimais.php">Adotar</a>
        </div>
        <div class="col-md"><a class="btn text-white btn-lg btn-block bgAzul butHover"
            href="listarAnimaldoUsuario.php">Seus animais</a></div>
        <?php 
            ...
            ?>
        <div class="col-md"><a class="btn text-white btn-lg btn-block bgAzul butHover"
            href="listarAnimal.php">Aprovações</a></div>
      </div>
    </div>
  </div>
  </div>
