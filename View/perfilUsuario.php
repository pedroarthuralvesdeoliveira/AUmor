...
if ($usuario->tipoUser == 1) {
  header('Location:perfilUsuarioAdmin.php');
}
        ...
        <!-- Fazer com que o sistema mande outro email para o usuário   -->
          <?php 
            if ($_SESSION['statusValidacao'] != 1) {
              echo "<div class='col-md'> <button type='button' class='btn text-white btn-lg btn-block bgAzul butHover' data-bs-toggle='modal' data-bs-target='#modalEmail'> Cadastrar animais</button></div>";        
            } else {
              echo "<div class='col-md'><a class='btn text-white btn-lg btn-block bgAzul butHover' href='cadastrarAnimal.php'>Cadastrar animais</a></div>";
            }
          ?>
            <div class="col-md"><a class="btn text-white btn-lg btn-block bgAzul butHover" href="feedAnimais.php">Adotar animais</a></div>
